...
DrawPlayerHUDAndHPBar:
	...
	ld [hl], $73
	ld de, wBattleMonNick
	coord hl, 9, 8 ;coord hl, 10, 7 changed
	call CenterMonName
	call PlaceString
	ld a, c
...
DrawEnemyHUDAndHPBar:
	...
	ld de, wEnemyMonNick
	coord hl, 0, 1 ;coord hl, 1, 0 changed
	call CenterMonName
	call PlaceString
	ld h, b
	ld l, c
...
; put cursor in left column for normal battle menu (i.e. when it's not a Safari battle)
	Coorda 13, 14 ;Coorda 15, 14 ; clear upper cursor position in right column
	Coorda 13, 16 ;Coorda 15, 16 ; clear lower cursor position in right column
	ld b, $9 ; top menu item X
	jr .leftColumn_WaitForInput
.safariLeftColumn
	Coorda 13, 14
	Coorda 13, 16
	coord hl, 8, 14 ;coord hl, 7, 14
...
.regularmenu
	...
	coord hl, 2, 10
	call .writemoves
	ld b, $1 ;ld b, $5 chagned<
	ld a, $8 ;ld a, $c chagned<
	jr .menuset
.mimicmenu
...
; print TYPE/<type> and <curPP>/<maxPP>
	coord hl, 11, 15 ;coord hl, 1, 9
	ld de, TypeText
	call PlaceString
	coord hl, 13, 16 ;coord hl, 7, 11
	ld [hl], "/"
	coord hl, 16, 13 ;coord hl, 5, 9
	ld [hl], "/"
	coord hl, 14, 13 ;coord hl, 5, 11
	ld de, wcd6d
	lb bc, 1, 2
	call PrintNumber
	coord hl, 17, 13 ;coord hl, 8, 11
	ld de, wMaxPP
	lb bc, 1, 2
	call PrintNumber
	call GetCurrentMove
	coord hl, 14, 16 ;coord hl, 2, 10
